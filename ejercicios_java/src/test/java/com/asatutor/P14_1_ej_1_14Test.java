...
public class P14_1_ej_1_14Test {
    ...
    @Test
    void main_cuandoSeIntroduceCero_dos() {
        provideInputAndRun("0\n");
        String output = outContent.toString();
        assertTrue(output.contains("El cuadrado de 2 es: 4.0"), "La salida debería contener el cuadrado de 2.");
        assertTrue(output.contains("El cubo de 2 es: 8.0"), "La salida debería contener el cubo de 2.");
    }
}